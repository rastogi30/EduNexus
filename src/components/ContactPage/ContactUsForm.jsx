    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-5">
          ...
          {errors.phoneNo && (<span className="-mt-1 text-[12px] text-yellow-100">
      ...
      <button
        disabled={loading}
        type="submit"
        className="text-center text-[17px] px-5 py-2 rounded-md font-bold bg-yellow-50 text-black
                     hover:scale-95 transition-all duration 200  shadow-richblack-100
                     shadow-[2px_2px_0px_0px] hover:text-[19px]"
        //    ${
        //    !loading &&
