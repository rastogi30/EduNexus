...
export default function CoursesTable({ courses, setCourses }) {
  ...
  const handleCourseDelete = async (courseId) => {
    ...
    console.log("Course Table component mei kya aya h...", result);
    if (result) {
      setCourses(result)
    }
              ...
              >
                ...
                <Td className="max-sm:text-[10px] sm:text-xs md:text-sm lg:text-base font-medium text-richblack-100 ">
                  <button
                    ...
                    title="Edit"
                    className="px-2 transition-all duration-200 hover:scale-150 hover:text-caribbeangreen-300"
                  >
                  ...
                  <button
                    ...
                    title="Delete"
                    className="px-1 transition-all duration-200 hover:scale-150 hover:text-[#ff0000]"
                  >
