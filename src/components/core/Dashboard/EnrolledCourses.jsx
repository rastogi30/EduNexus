                        ...
                        enrolledCourses.map((course, index, arr) => (
                            <div className={`flex items-center border border-richblack-700 ${
                                ...
                                <div className="flex w-[45%] cursor-pointer items-center gap-4 px-5 py-3"
                                    onClick={() => {
                                    navigate(
                                        `/view-courses/${course?._id}/section/${course.courseContent?.[0]?._id}/sub-section/${course.courseContent?.[0]?.subSection?.[0]?._id}`
                                    )
                                    }}>
                                ...
                                <div className="flex w-1/5 flex-col gap-2 px-2 py-5">
                                    <p>Progress: {course.progressPercentage || 0}%</p>
                                    <ProgressBar
                                        completed = {course.progressPercentage || 0}
                                        height="10px"
                                        bgColor="#A855F7" // Change bar color
                                        baseBgColor="#E0E0E0" // Change background color of the bar
                                        labelAlignment="center" // Align label properly
                                        labelColor="#fff" // Label text color
                                        borderRadius="5px"
                                        animateOnRender
                                        customLabelStyles={{
                                            fontSize: "12px",
