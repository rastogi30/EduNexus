    ...
    <div>
        ...
        <section className='bg-richblack-700'>
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                ...
                EduNexus is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering
                 cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
                </header>
                <div className="sm:h-[70px] lg:h-[150px]"></div>
                <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
                    <img src={BannerImage1} alt="image not loading" loading='lazy'/>
                    <img src={BannerImage2} alt="image not loading" loading='lazy'/>
                    <img src={BannerImage3} alt="image not loading" loading='lazy'/>
                </div>
            </div>
        </section>
                   ...
                   {/* founding story left box */}
                    ...
                    <div>
                        <img src={FoundingImage}
                          alt=""
                          className="shadow-[1px_1px_15px_1px_#FC6767,-1px_-1px_15px_1px_#ffffff]"
                        />
                    </div>
                ...
                <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
                    <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                     {/* left box */}
                        ...
                        Our Vision</h1>
                        <p className="text-base font-medium text-richblack-300 lg:w-[100%]">
                        ...
                        learn. Our team of dedicated experts worked tirelessly to develop a robust and intuitive platform that combines cutting-edge 
