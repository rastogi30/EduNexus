...
import ResendTimer from '../components/common/ResendTimmer';
...
const VerifyEmail = () => {
    ...
    const handleResendOtp = () => {
        dispatch(sendOtp(signupData.email, navigate)); // Call sendOtp action
      };
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] grid place-items-center">
        ...
        <h1 className="text-richblack-5 font-semibold text-[1.875rem] leading-[2.375rem]">Verify Email</h1>
            ...
            A Verification code has been sent to you. Enter the code blow</p>
            ...
            <div className="mt-6 flex items-center justify-between" >
                ...
                <ResendTimer onResend={handleResendOtp} initialSeconds={15} />
            </div>
        </div>)
        }
    </div>
